...
void DiffDriveUpdater::update(ParticleArray::iterator begin,
  ...
  std::uniform_real_distribution<double> v_hat_dist(0, params_.alpha_1_ * std::fabs(measurement.v) + params_.alpha_2_ * std::fabs(measurement.w));
  std::uniform_real_distribution<double> w_hat_dist(0, params_.alpha_3_ * std::fabs(measurement.v) + params_.alpha_4_ * std::fabs(measurement.w));
  std::uniform_real_distribution<double> g_hat_dist(0, params_.alpha_5_ * std::fabs(measurement.v) + params_.alpha_6_ * std::fabs(measurement.w));
